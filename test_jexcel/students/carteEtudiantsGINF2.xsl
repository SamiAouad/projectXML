...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
    ...
    <xsl:template match="students" name="main">
        <xsl:variable name="student" select="students/student[@CNE='B12']"/>
        <fo:table > 
            <fo:table-body>
                <fo:table-row
                    ...
                    <fo:table-cell text-align="left">
                        <fo:block
                            >
                            <fo:external-graphic content-height="10mm" content-width="auto" src="../images/logoENSAT.png"/>
                        </fo:block>
                    ...
                    <fo:table-cell text-align="right" margin-right="4px">
                        <fo:block
                            >
                            <fo:external-graphic content-height="8mm" content-width="24mm" src="../images/logoUni.png"/>
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
